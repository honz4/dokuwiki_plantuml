...
private function append3bytes($b1, $b2, $b3) {
     ...
     $c4 = $b3 & 0x3F;
     $r = "";
     $r .= $this->encode6bit($c1 & 0x3F) . $this->encode6bit($c2 & 0x3F) . $this->encode6bit($c3 & 0x3F) . $this->encode6bit($c4 & 0x3F);
     return $r;
}
//Hmm, base64_encode() nelze pouzit!
